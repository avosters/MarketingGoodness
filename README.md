...
### `polish-writing/`
A skill that sharpens any text on command. Say "polish this" and Claude rewrites it using six rules, applied together every time:
...
6. **No em dashes** — em dashes get rewritten as periods, commas, colons, or parentheses instead.
...
Most writing tools either rewrite too much (changing meaning) or too little (fixing typos only). This skill targets the six things that most often make marketing writing sound vague or passive, without touching the substance.
