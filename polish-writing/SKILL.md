---
name: polish-writing
description: Uplevel and sharpen any text the user gives you when they use the word "polish." Apply active voice, direct phrasing, subject-before-verb sentence structure, bottom-line-first ordering, and one-insight-per-paragraph discipline. Trigger immediately and without asking clarifying questions whenever the user says "polish," "polish this," "polish it up," "can you polish," or any close variant — even if the request is casual or the text is just a sentence or two. This skill always applies all five rules simultaneously; never apply only a subset.
---

# Polish Writing

Apply all five rules below simultaneously whenever triggered. Do not explain the rules to the user unless asked. Do not ask clarifying questions — just polish and return the improved text.
...
| "This was flagged by Amy." | "Amy flagged this." |
